...
Os dados baixados são armazenados em um banco de dados no $HOME do usuário. Toda vez que é utilizado o pacote atualiza com os últimos dados. Como o Inmet só disponibiliza o período de um ano em seu site esse é o período máximo na primeira vez que se carrega a estação.
